...
def create_preconditioner(x):
  """Allocate a zero (d, d) preconditioner matching `x`'s last-dim, dtype, and device."""
...
class LoRARite(Optimizer):
  """LoRA-RITE optimizer: rotation-invariant transformation-equivariant updates over LoRA A/B pairs."""
